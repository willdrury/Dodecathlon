...
class SubmissionApprovalScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('Submission Approval'),
        ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        OutlinedButton.icon(
                          label: Text('Approve', style: TextStyle(fontSize: 20),),
                          onPressed: () {
                        ...
                        SizedBox(width: 20,),
                        OutlinedButton.icon(
                          label: Text('Deny', style: TextStyle(fontSize: 20),),
                          onPressed: () {
                            // TODO: handle better
                    ...
                    Align(
                      ...
                      child: OutlinedButton.icon(
                        label: Text('Not enough info', style: TextStyle(fontSize: 20),),
                        onPressed: () {
                          // TODO: handle better
                          Navigator.of(context).pop();
                        },
